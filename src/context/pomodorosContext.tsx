...
export const PomodoroContext = React.createContext<pomodoroContextType>({} as pomodoroContextType)
        ...
        case 'start':
            return {
                ...
                pomodorosArray: state.pomodorosArray.map(individualPomodoro => {
                    ...
                    if (individualPomodoro.id !== action.id && individualPomodoro.runningPomodoroStartedAt !== null) {
                        return {
                            ...individualPomodoro,
                            //@ts-ignore
                            pausedPomodoroMSecondsPassed: individualPomodoro.pausedPomodoroMSecondsPassed + (new Date() - individualPomodoro.runningPomodoroStartedAt),
...
export const PomodoroContextWrapper = ({ children }: PomodoroContextWrapperPropsType): JSX.Element => {
