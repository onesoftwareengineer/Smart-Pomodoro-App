        ...
        pomodorosArray: state.pomodorosArray.map(individualPomodoro => {
          ...
          if (individualPomodoro.id === action.id) {
            return { ...individualPomodoro,
              pausedPomodoroMSecondsPassed: individualPomodoro.pausedPomodoroMSecondsPassed + ( //@ts-ignore
...
export const PomodoroContext = /*#__PURE__*/React.createContext({}); //component
